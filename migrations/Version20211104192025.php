 ...
 */
final class Version20211104192025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD state SMALLINT DEFAULT 0 NOT NULL, ADD available_at DATETIME DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP state, DROP available_at, DROP image');
    }
}
